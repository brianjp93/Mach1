...
def move_up():
	...
	dev.zaberMove("ver", command = dev.cmd["moveRelative"], data=opticDiameter + 20)

	print("creating v1, v2 lists.")
	v1 = dev.getWaveform(ch="CH1")
	v2 = dev.getWaveform(ch="CH2")
...
def calibrateHere():
	...
	dev.setSecDiv("1")
	dev.trigger()
	_cal1 = dev.getAvgOfSamples(ch="CH1", samples=2500)
	_cal2 = dev.getAvgOfSamples(ch="CH2", samples=2500)
	dev.setSecDiv("2")
	return _cal1, _cal2
...
def calibrateUp():
	...
	global dev
	dev.setSecDiv("1")
	print(dev.zaberMove("ver", command = dev.cmd["moveRelative"], data = 20))
	time.sleep(5)
	dev.trigger()
	_cal1 = dev.getAvgOfSamples(ch="CH1", samples=2500)
	_cal2 = dev.getAvgOfSamples(ch="CH2", samples=2500)
